			...
			<div class="row gx-5 justify-content-center">
				<div class="col-lg-6">
					<div class="text-center my-5">
						...
						<p class="lead text-white mb-4">The Best Food Delivery
							Application</p>
	...
	<div class="container register">
		<div class="row">
			<div class="col-md-3 register-left">
				...
				<h3>Welcome</h3>
				<p>You are few seconds away from creating your account</p>
			...
			<div class="col-md-9 register-right">
				...
				<div class="tab-content" id="myTabContent">
					<div class="tab-pane fade show" id="client-form"
						role="tabpanel" aria-labelledby="client-tab2">
						<h3 class="register-heading">SignUp as a Client</h3>
						<div class="row register-form">


							<div class="col-md-9">
								<form action="createClient" id="create-client-form"
									onsubmit="return createClient()" method="post">
									<div class="form-group">
										<input type="text" class="form-control" placeholder="Pseudo *"
											value="" name="pseudo" id="clientPseudo" />
									</div>
									<div class="form-group">
										<input type="text" class="form-control"
											placeholder="Address *" value="" name="address"
											id="clientAddress" />
									</div>

									<div class="form-group">
										<input type="password" class="form-control"
											placeholder="Password *" value="" name="pwd" id="clientPWD" />
									</div>
									<div class="form-group">
										<input type="password" class="form-control"
											placeholder="Confirm Password *" value="" name="repwd"
											id="clientPWD2" />
									</div>
					...
					<div class="tab-pane fade show" id="driver-form" role="tabpanel"
						...
						<h3 class="register-heading">SignUp as a Driver</h3>
						<div class="row register-form">
							<div class="col-md-12">
								<form action="createDriver" id="create-driver-form"
									onsubmit="return createDriver()" method="post">
									<div class="form-group">
										<input type="text" class="form-control" placeholder="Pseudo *"
											value="" name="pseudo" id="driverpseudo" />
									</div>
									<div class="form-group">
										<input type="password" class="form-control"
											placeholder="Password *" value="" name="pwd" id="driverpwd" />
									</div>
									<div class="form-group">
										<input type="password" class="form-control"
											placeholder="Confirm Password *" value="" name="repwd"
					...
					<div class="tab-pane fade show active" id="restaurant-form"
						role="tabpanel" aria-labelledby="driver-tab">
						<h3 class="register-heading">SignUp as a Restaurant</h3>
						<div class="row register-form">
							<div class="col-md-9">
								<form action="createRestaurant" id="create-restaurant-form"
									onsubmit="return createrestaurant()" method="post">
									<div class="form-group">
										<input type="text" class="form-control"
											placeholder="Restaurant Name *" value="" name="name"
											id="RName" />
									</div>
									<div class="form-group">
										<input type="text" class="form-control" placeholder="Pseudo *"
											value="" name="pseudo" id="Rpseudo" />
									</div>
									<div class="form-group">
										<input type="password" class="form-control"
											placeholder="Password *" value="" name="pwd" id="Rpwd" />
									</div>
									<div class="form-group">
										<input type="password" class="form-control"
											placeholder="Confirm Password *" value="" name="repwd"

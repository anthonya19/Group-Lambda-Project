...
<script src="//cdnjs.cloudflare.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
    ...
    <body>
        ...
        <!-- Header-->
        <header class=" py-5">
            <div class="container px-5" style="background-image: url('assets/background2.png');
			height: 400px;
			width: 1200px;">
                <div class="row gx-5 justify-content-center">
                    <div class="col-lg-6">
                        <div class="text-center my-5">
                            <h1 class="display-5 fw-bolder text-white mb-2">MThree Food Delivery Application</h1>
                            <p class="lead text-white mb-4">The Best Food Delivery Application</p>
        ...
        <div class="container register">
                <div class="row">
                    <div class="col-md-3 register-left">
                        ...
                        <input type="submit" name="" value="Login" onclick="Client_login()"/><br/>
                    </div>
                    <div class="col-md-9 register-right">
                        <ul class="nav nav-tabs nav-justified" id="myTab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="client-tab" data-toggle="tab" role="tab" aria-controls="client" aria-selected="true">Client</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="driver-tab" data-toggle="tab" role="tab" aria-controls="driver" aria-selected="false">Driver</a>
                            </li>
                        </ul>
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="client-form" role="tabpanel" aria-labelledby="client-tab">
                            ...
                            <div class="tab-pane fade show" id="driver-form" role="tabpanel" aria-labelledby="driver-tab">
